...
class Song{
    ...
    howMany(arr) {
      this.listeners = arr.map(el=> el.toLowerCase()).filter((el,i,ar)=> ar.indexOf(el)==i)
      this.new = this.listeners.filter((el)=> !this.arr.includes(el))
      this.arr = this.arr.concat(this.new)
