...
function askForMissingDetails(list) {
  ...
  let missingDetails = list.filter(dev=> keys.some(key=> dev[key]==null))
  missingDetails.forEach(dev=> 
    dev.question = `Hi, could you please provide your ${keys.filter(key=> dev[key]==null)}.`
  )
